	...
	window.addEvent('domready', function() {
		...
		$('annuler_demande').addEvent('click', function(event) {
			...
			var myAjax = new Request.HTML({
				'url':'/base_loisirs/demande/annuler_demande/', 
					...
					<table class="ticket_header_sub">
						<tbody>
							...
							<tr>
								...
								<td>
									<input name="bl_heure_arr" type="text" id="bl_heure_arr" placeholder="hh:mm" onblur="" value="<?php echo $this->session->userdata('heure_arrivee'); ?>" maxlength="100" class="input_date fl">
							...
							<tr>
								...
								<td>
									<input name="bl_heure_dep" type="text" id="bl_heure_dep" placeholder="hh:mm" onblur="" value="<?php echo $this->session->userdata('heure_depart'); ?>"  maxlength="100" class="input_date fl">
				...
				<tr>
					<td align="right" colspan="2" class="ithd_wrapper_button">
						<div id="save_global">
							...
							<?php } ?>
							<?php if(!$modifier) { ?><input name="annuler_demande" type="button" id="annuler_demande" value="Annuler" class="tpl_button_cancel" />
							
							<?php } 
							if($this->session->userdata('id_demandes')) {
								
								if($this->resa->reservation_est_modifiable($this->session->userdata('id_demandes'))) {
									?>
...
window.addEvent('domready', function() {
	...
	var dateArr = new CalendarEightysix('bl_date_arr', {'disallowUserInput': true, 'defaultDate':'<?php echo $this->session->userdata('date_arrivee'); ?>', 'startMonday' : true, <?php if($this->resa->reservation_est_modifiable($this->session->userdata('id_demandes'))) { ?>'minDate':'<?php echo date("m/d/Y",strtotime('+4 days')); ?>',<?php } ?> 'format': '%d/%m/%Y', 'offsetY': -4, 'maxDate':'<?php echo date("m/d/Y",strtotime($this->saison->fin_saison($this->session->userdata('id_saison')))); ?>' });
	var dateDep = new CalendarEightysix('bl_date_dep', {'disallowUserInput': true, 'defaultDate':'<?php echo $this->session->userdata('date_depart'); ?>', <?php if($this->resa->reservation_est_modifiable($this->session->userdata('id_demandes'))) { ?>'minDate':'<?php echo date("m/d/Y",strtotime('+5 days')); ?>',<?php } ?> 'format': '%d/%m/%Y', 'offsetX': -4, 'maxDate':'<?php echo date("m/d/Y",strtotime($this->saison->fin_saison($this->session->userdata('id_saison')))); ?>' });
	<?php } elseif($this->session->userdata('date_arrivee') && $this->session->userdata('session_prochaine')) { ?>
	var dateArr = new CalendarEightysix('bl_date_arr', {'disallowUserInput': true, 'defaultDate':'<?php echo $this->session->userdata('date_arrivee'); ?>', 'startMonday' : true, <?php if($this->resa->reservation_est_modifiable($this->session->userdata('id_demandes'))) { ?>'minDate':'<?php echo $this->session->userdata('date_arrivee'); ?>',<?php } ?> 'maxDate':'<?php echo date("m/d/Y",strtotime($this->saison->fin_saison_prochaine())); ?>', 'format': '%d/%m/%Y', 'offsetY': -4 });
	var dateDep = new CalendarEightysix('bl_date_dep', {'disallowUserInput': true, 'defaultDate':'<?php echo $this->session->userdata('date_depart'); ?>', 'format': '%d/%m/%Y', 'minDate':'<?php echo $this->session->userdata('date_arrivee'); ?>', 'offsetY': -4, 'maxDate':'<?php echo date("m/d/Y",strtotime($this->saison->fin_saison_prochaine())); ?>' });
	<?php } elseif(!$this->session->userdata('date_arrivee') && $this->session->userdata('session_prochaine')) { ?>
	var dateArr = new CalendarEightysix('bl_date_arr', {'disallowUserInput': true, 'defaultDate':'<?php echo date("m/d/Y",strtotime('+8 days')); ?>', 'startMonday' : true, 'minDate':'<?php echo date("m/d/Y",strtotime('+4 days')); ?>', 'maxDate':'<?php echo date("m/d/Y",strtotime($this->saison->fin_saison_prochaine())); ?>', 'format': '%d/%m/%Y', 'offsetY': -4 });
	var dateDep = new CalendarEightysix('bl_date_dep', {'disallowUserInput': true, 'defaultDate':'<?php echo date("m/d/Y",strtotime('+11 days')); ?>', 'format': '%d/%m/%Y', 'minDate':'<?php echo date("m/d/Y",strtotime('+10 days')); ?>', 'offsetY': -4, 'maxDate':'<?php echo date("m/d/Y",strtotime($this->saison->fin_saison_prochaine())); ?>' });
	<?php } else { ?>
	var dateArr = new CalendarEightysix('bl_date_arr', {'disallowUserInput': true, 'defaultDate':'<?php echo date("m/d/Y",strtotime('+8 days')); ?>', 'startMonday' : true, 'minDate':'<?php echo date("m/d/Y",strtotime('+4 days')); ?>', 'maxDate':'<?php echo date("m/d/Y",strtotime($this->saison->fin_saison($this->session->userdata('id_saison')))); ?>', 'format': '%d/%m/%Y', 'offsetY': -4 });
	var dateDep = new CalendarEightysix('bl_date_dep', {'disallowUserInput': true, 'defaultDate':'<?php echo date("m/d/Y",strtotime('+11 days')); ?>', 'format': '%d/%m/%Y', 'minDate':'<?php echo date("m/d/Y",strtotime('+10 days')); ?>', 'offsetY': -4, 'maxDate':'<?php echo date("m/d/Y",strtotime($this->saison->fin_saison($this->session->userdata('id_saison')))); ?>' });
	<?php } ?>
	...
	var url_cancel = window.location.origin + '/base_loisirs.php/demande/notif_cancel/';
	...
	// New : Timepicker for time input
	$j('#bl_heure_arr').timepicker();
	$j('#bl_heure_dep').timepicker();
});	
</script>
