...
<div id="left_menu"><!--
	...
	<div class="left_menus">
		<h2>Manuel</h2>
		<ul>
			<li><a target="_blank" href="http://dlawebprd2.cm.perenco.com/assets/base_loisirs/img/ManagerUserGuide.pdf" class="level2"><span>Guide Gestionnaire</span></a></li>
		</ul>
	</div>
	<?php  } elseif($this->user->is_hr_manager($this->session->userdata('iduser'))) { ?>
	<div class="cleardiv">&nbsp;</div>
	<div class="left_menus">
		<h2>Manuel utilisateur</h2>
		<ul>
			<li><a target="_blank" href="http://dlawebprd2.cm.perenco.com/assets/base_loisirs/img/UserGuide.pdf" class="level2"><span>Guide utilisateur</span></a></li>
		</ul>
	</div>
	<?php  } else { ?>
	<div class="cleardiv">&nbsp;</div>
	...
	<div class="left_menus">
		...
		<ul>
			...
			<li><a class="level1 level2selected" href="base_loisirs.php/base_loisirs/about/" target="_self"><span>&raquo; A propos</span></a></li>
			<?php } else { ?>
			<li><a class="level1" href="base_loisirs.php/base_loisirs/about/" target="_self"><span>A propos</span></a></li>
			<?php } ?>
		</ul>
	</div>
	<?php if($this->user->is_manager($this->session->userdata('iduser')) || $this->user->is_administrator($this->session->userdata('iduser'))) { ?>
	...
	<div class="left_menus">
		<h2>Gestion</h2>								
			<ul>
				...
				<?php } ?>
				<?php if($this->uri->uri_string() == 'admresas/booking_stats') { ?>
				<li><a href="base_loisirs.php/admresas/booking_stats" class="level2selected " target="_self"><span class="">&raquo; Statistiques</span></a></li>
				<?php } else { ?>
				<li><a href="base_loisirs.php/admresas/booking_stats" class="level2 " target="_self"><span>Statistiques</span></a></li>
				<?php } ?>
			</ul>
	</div>
	<?php  } ?>
