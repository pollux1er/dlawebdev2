...
<link rel="icon" href="<?php echo base_url(); ?>/favicon.ico" type="image/x-icon">
	...
	<link rel="stylesheet" href="assets/base_loisirs/css/simplemodal.css" type="text/css" media="screen" title="no title" charset="utf-8">
	...
	<script type="text/javascript" src="assets/base_loisirs/js/user.js?nocache=60"></script>
	<script src="assets/base_loisirs/js/simple-modal.js" type="text/javascript" charset="utf-8"></script>
...
<?php 
	//var_dump($users); die;
	$users['users'] = $users;
	$users['nusers'] = $all_non_users;
	echo $this->load->view('adm/adm_liste_ayantdroits', $users);
