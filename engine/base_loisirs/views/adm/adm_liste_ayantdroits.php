...
<div style="border:1px solid gray;" class="tpl_box_init_container">
	...
	<?php } ?>
	<span>
		<!--<img title="Générer le fichier PDF" style="margin:2px 0 2px 10px; cursor:help;  float:right" src="assets/base_loisirs/images/pdf.png">-->
		<a class="tpl_button_pdf" style="background-image: url(&quot;assets/base_loisirs/images/pdf.png&quot;);float:right;margin: 0 5px;" href="<?php echo base_url(); ?>base_loisirs.php/admresas/users_to_pdf" target="_bank">Extraire la liste en PDF</a>
	</span>
	<br />	
