...
<?php 
	...
	if(isset($success_msg)) {
		$db['success_msg'] = $success_msg; 
		$db['upload_data'] = $upload_data;
	}
	if(isset($error)) $db['error'] = $error;
	if(isset($csv)) $db['csv'] = $csv;
	echo $this->load->view('adm/admin_load_csv_gsm2', $db);
