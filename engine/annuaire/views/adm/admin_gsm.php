...
<head>
	...
	<script src="assets/annuaire/js/jquery-2.1.4.min.js"></script>
	<script src="assets/annuaire/js/jquery-ui.min.js"></script>
	<script src="assets/annuaire/js/annuaire.js"></script>
	<script src="assets/annuaire/js/angular.min.js"></script>
	<script src="assets/annuaire/js/xeditable.min.js"></script>
...
<?php 
	//var_dump($annuaire); die;
	$db['users'] = $annuaire;
	$db['departments'] = $departements;
	$db['formules'] = $formules;
	$db['statuses'] = $statuses;
	echo $this->load->view('admin2_cout_gsm', $db);
