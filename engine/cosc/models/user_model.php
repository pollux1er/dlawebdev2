...
class User_model extends CI_Model {
	...
	{
		$sql = "SELECT u.user_id, u.First_Name, u.Last_Name, CONCAT(u.First_Name, ' ', u.Last_Name) as nom, u.`Professional E-mail` as email FROM `userscm` AS u  WHERE bl IN ('2') OR user_id IN ('14194') ";
	...
	{
		$sql = "SELECT u.user_id, u.First_Name, u.Last_Name FROM `userscm` AS u  WHERE bl IN ('2') AND user_id IN ('$id') LIMIT 1 ";
	...
	{
		$sql = "SELECT u.user_id FROM `userscm` AS u  WHERE bl IN ('1', '2', '3', '4') AND user_id IN ('$id') LIMIT 1 ";
