...
<div style="border:1px solid gray;" class="tpl_box_init_container">
	...
	<select name="statut" id="statut" onChange="this.form.submit();">
		...
		<option value="1" <?php if($statut == '1') echo 'selected="selected"'; ?>>En attente</option>
		<option value="2" <?php if($statut == '2') echo 'selected="selected"'; ?>>Reservée</option>
		<option value="3" <?php if($statut == '3') echo 'selected="selected"'; ?>>Confirmée</option>
		<option value="0" <?php if($statut == '0') echo 'selected="selected"'; ?>>Annulée</option>
	</select>
	Case 
	<select name="idcase" id="idcase" onChange="this.form.submit();">
		<option value="*" <?php if($case == '*') echo 'selected="selected"'; ?>>Toutes les cases</option>
		<option value="3" <?php if($case == '3') echo 'selected="selected"'; ?>>Grande case</option>
		<option value="1" <?php if($case == '1') echo 'selected="selected"'; ?>>Case verte</option>
		<option value="2" <?php if($case == '2') echo 'selected="selected"'; ?>>Case bleue</option>
		<option value="4" <?php if($case == '4') echo 'selected="selected"'; ?>>Case jaune</option>
	</select><br />
	</form>
	[ <a id="label_hide_show_log" onclick="showme(this.id); return false;" href="">Montrer logs des historiques</a> ]
