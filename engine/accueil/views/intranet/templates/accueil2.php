	...
	<style type="text/css">
		<!--
			...
			#barre_select
			{
				...
				background: url(./assets/css/Perenco2/images/lil_ban_3.png) repeat-x scroll left bottom;
				/*width: 537px;*/
				padding: 5px;
				height:25px;
			...
			.odd_title
			{
				...
				background: url(./assets/css/List/green-top-bottom-50px.png) repeat-x scroll left bottom;
				border: 0;
						...
						<div id="div_ph">
							...
							<div id="barre_select" align="center">
								<div id="page_1" class="nav_diapo" align="center">
									<a name="deb_vehicule" style="display:none;" class="disabled" onclick="_deb(this)"> ‹ Debut </a>
									<a name="prec_vehicule" style="" onclick="_prec(this)"> &lt; </a>
									...
									<a name="step_vehicule_3" style="" onclick="_step(this)">4</a>
									<a name="step_vehicule_4" style="" onclick="_step(this)">5</a>
