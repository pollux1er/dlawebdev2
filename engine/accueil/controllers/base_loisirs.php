<?php
class Base_loisirs extends PRDR_Controller{
	...
	public function index(){
		...
		$this->define_header();
		$this->define_left_menu('intranet/left_menu1');
		
		$param = array();
		
		$param['method'] = "base_loisir";
		
		$this->define_view('intranet/templates/base_loisir', $param);
	}
}