    ...
    $.fn.bcalendar = function(option) {
				...
				// {
					...
					// {
						...
						// {
							...
							// il.setAttribute('onclick','put(this);')
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                temparr.push(i18n.xgcalendar.caller,':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-caller" name="client" class="textbox-fill-input" onKeyup="l_clt(this)"/></div></div></tr><tr><th class="cb-key">');
				temparr.push(i18n.xgcalendar.dept,':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-dept" class="textbox-fill-input"/></div></div></tr><tr><th class="cb-key">');
				temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-what" class="textbox-fill-input"/></div></div></tr><tr><th class="cb-key">');
                temparr.push(i18n.xgcalendar.ride,':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-ride" class="textbox-fill-input"/></div></div></tr><tr><th class="cb-key">');
				temparr.push(i18n.xgcalendar.boss,':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-boss" name="client" class="textbox-fill-input" onKeyup="l_clt(this)"/></div></div></td></tr></tbody></table><input id="bbit-cal-clt" type="hidden"/><input id="bbit-cal-start" type="hidden"/><input id="bbit-cal-end" type="hidden"/><input id="bbit-cal-allday" type="hidden"/><input id="bbit-cal-quickAddBTN" value="');
				...
				$('.bubble-table').before('<div id="list" style="max-height:200px; overflow-y:scroll; border:1px solid darkgray; padding:5px; position:absolute; z-index:10; visibility:hidden; background-color:white;"></div>');
                ...
                calbutton.click(function(e) {
                    ...
                    option.isloading = true;
                    var caller = $("#bbit-cal-caller").val();
					var dept = $("#bbit-cal-dept").val();
					var what = $("#bbit-cal-what").val();
					var ride = $("#bbit-cal-ride").val();
					var boss = $("#bbit-cal-boss").val();
					var clt = $("#bbit-cal-clt").val();
                    ...
                    var param = [{ "name": "CalendarTitle", value: what },
						{ "name": "Departement", value: dept },
						{ "name": "Demandeur", value: caller },
						{ "name": "trajet", value: ride },
						{ "name": "Responsable", value: boss },
						{ "name": "Client", value: clt },
			...
			//simule le focus sur le input
            var calwhat = $("#bbit-cal-caller").val("");
			
			//effacer les inputs du formulaire quickAdd
			$("#bbit-cal-dept").val("");
			$("#bbit-cal-what").val("");
			$("#bbit-cal-boss").val("");
			$("#bbit-cal-ride").val("");
