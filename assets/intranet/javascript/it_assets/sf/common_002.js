...
function switchTabCard( section_name, todo_mode )
{
	...
	var list_section = Array( 'common', 'esx', 'procedures', 'comments', 'credential', 'status', 'lastconf', 'logs', 'monitor' ); // 'services', 'specific','schedule',  'server_credential',
...
function callback_ajax_ip_addr( res_action, id_increment )
{
	if( res_action != 0 )
	{
...
function showhide_criteria_more()
{
	if( $('tr_criteria_more').style.display == 'none' )
	{
		...
		$('img_plusminus_criteria_more').src="/IT_Assets/assets/images/b_minus.png";
	}
	else
	{
		$('tr_criteria_more').style.display = 'none'; 	
		$('img_plusminus_criteria_more').src="/IT_Assets/assets/images/b_plus.png";
	}
}
