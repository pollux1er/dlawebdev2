...
function Datepicker() {
	...
	this.regional[''] = { // US/English
		...
		prevText: '&lt;préc', // Text for the previous month command
		prevStatus: 'Montrer le mois précédent', // Status text for the previous month command
		prevJumpText: '&lt;&lt;', // Text for the previous year command
		prevJumpStatus: 'Montrer l\'année précédente', // Status text for the previous year command
		nextText: 'Suivant&gt;', // Text for the next month command
		nextStatus: 'Montrer le mois suivant', // Status text for the next month command
		nextJumpText: '&gt;&gt;', // Text for the next year command
		nextJumpStatus: 'Montrer l\'anné suivante', // Status text for the next year command
		currentText: 'Current', // Text for the current month command
		currentStatus: 'Montrer le mois actuel', // Status text for the current month command
		todayText: 'Aujourd\'hui', // Text for the today's month command
		todayStatus: 'Montrer mois du jour', // Status text for the today's month command
		clearText: 'Effacer', // Text for the clear command
		clearStatus: 'Effacer toutes les dates', // Status text for the clear command
		closeText: 'Fermer', // Text for the close command
		closeStatus: 'Fermer le selecteur de dates', // Status text for the close command
		yearStatus: 'Changer l\'année', // Status text for year selection
		monthStatus: 'Changer le mois', // Status text for month selection
		weekText: 'Wk', // Text for week of the year column header
		weekStatus: 'Semaines de l\'année', // Status text for week of the year column header
		dayStatus: 'DD, d M yyyy', // Status text for selectable days
		defaultStatus: 'Choisir une date', // Status text shown by default
