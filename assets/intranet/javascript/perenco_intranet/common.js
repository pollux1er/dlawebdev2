 ...
 */
  ...
  $(document).ready(function() 
  {
	...
	if( body )
	{
		$(body).mouseout(function(){ showMenu(); });
	}
	...
	if( version_expand )
	{
		$(version_expand).mouseover(function( e ) { this.setStyle( 'cursor', 'pointer' ); });
		$(version_expand).mouseout(function( e ) { this.setStyle( 'cursor', 'default' ); })
	}
